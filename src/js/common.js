...
const summaryHeadTitle = ["#", "Mã CP", "Ngành <image class='tr-cursor filter-popover float-right' src='src/images/filter.png' data-bs-toggle='popover' id='summary-popover'/>", "Giá đóng cửa", "Thay đổi giá", "% Thay đổi giá", "Giá vốn", "Giá trị", "Tổng giá trị"];
const subSummaryHeadTitle = ["Tự doanh", "Khối ngoại"];
const locale = 'en-GB';
...
const DATA_URL = "https://data-statistics-api.herokuapp.com";
...
const ATTACHMENT_URL = "https://cdn.fialda.com/Attachment";
...
const FIALDA_ANALYSIS_REPORT_URL = `${ATTACHMENT_URL}/AnalysisReport/`;
const FIALDA_NEWS_URL = `${ATTACHMENT_URL}/News/`;
