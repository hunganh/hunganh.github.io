window.variablesJS = {
    ...
    statisticsHeadTitle : ["#", "Mã CP", "Ngành <image class='tr-cursor filter-popover float-right' src='src/images/filter.png' data-bs-toggle='popover' id='statistics-popover'/>", "Tổng khối lượng", "Tổng giá trị", "Giá đóng cửa", "Thay đổi giá", "% Thay đổi giá", "Giá vốn"],
    summaryHeadTitle : ["#", "Mã CP", "Ngành <image class='tr-cursor filter-popover float-right' src='src/images/filter.png' data-bs-toggle='popover' id='summary-popover'/>", "Giá đóng cửa", "Thay đổi giá", "% Thay đổi giá", "Giá vốn", "Giá trị", "Tổng giá trị"],
